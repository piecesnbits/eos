...
export declare function stringToPublicKey(s: string, prefix?: string): Key;
/** Convert `key` to string (base-58) form */
export declare function publicKeyToString(key: Key): string;
/** If a key is in the legacy format (`EOS` prefix), then convert it to the new format (`PUB_K1_`).
 * Leaves other formats untouched
 */
export declare function convertLegacyPublicKey(s: string, prefix?: string): string;
/** If a key is in the PUB_K1 format, then convert it to the legacy
 */
export declare function convertK1ToLegacyPublicKey(publicKey: string, prefix?: string): string;
/** If a key is in the legacy format (`EOS` prefix), then convert it to the new format (`PUB_K1_`).
 * Leaves other formats untouched
 */
export declare function convertLegacyPublicKeys(keys: string[], prefix?: string): string[];
/** Convert key in `s` to binary form */
