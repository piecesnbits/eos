...
var ser = __importStar(require("./eosjs-serialize"));
...
var Api = /** @class */ (function () {
    ...
    Api.prototype.deserializeActionsSync = function (actions) {
        return __awaiter(this, void 0, void 0, function () {
            var e_4, _a, deserializedActions, actions_1, actions_1_1, _b, account, name_2, authorization, data, contract, e_4_1;
            return __generator(this, function (_c) {
                switch (_c.label) {
                    ...
                    case 2:
                        ...
                        _b = actions_1_1.value, account = _b.account, name_2 = _b.name, authorization = _b.authorization, data = _b.data;
                        return [4 /*yield*/, this.getContract(account)];
                    case 3:
                        contract = _c.sent();
                        deserializedActions.push(ser.deserializeAction(contract, account, name_2, authorization, data, this.textEncoder, this.textDecoder));
                        _c.label = 4;
                    case 4:
                    ...
                    case 7:
                        ...
                        return [7 /*endfinally*/];
                    case 8: return [2 /*return*/, deserializedActions];
                }
            });
        });
    };
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        return [4 /*yield*/, this.deserializeActionsSync(deserializedTransaction.context_free_actions)];
                    case 1:
                        deserializedCFActions = _a.sent();
                        return [4 /*yield*/, this.deserializeActionsSync(deserializedTransaction.actions)];
                    case 2:
    ...
    Api.prototype.transact = function (transaction, _a) {
        var _b = _a === void 0 ? {} : _a, _c = _b.broadcast, broadcast = _c === void 0 ? true : _c, _d = _b.sign, sign = _d === void 0 ? true : _d, requiredKeys = _b.requiredKeys, // When you will sign later
        blocksBehind = _b.blocksBehind, expireSeconds = _b.expireSeconds, _e = _b.transactionHeader, transactionHeader = _e === void 0 ? undefined : _e;
        return __awaiter(this, void 0, void 0, function () {
            var info, taposBlockNumber, refBlock, error_1, _f, _g, abis, serializedTransaction, serializedContextFreeData, pushTransactionArgs, availableKeys;
            return __generator(this, function (_h) {
                switch (_h.label) {
                    ...
                    case 1:
                        ...
                        if (!!transactionHeader) return [3 /*break*/, 8];
                        if (!(typeof blocksBehind === 'number' && expireSeconds)) return [3 /*break*/, 7];
                    ...
                    case 12:
                        availableKeys = _h.sent();
                        if (!!requiredKeys) return [3 /*break*/, 14];
                        return [4 /*yield*/, this.authorityProvider.getRequiredKeys({ transaction: transaction, availableKeys: availableKeys })];
                    case 13:
                        requiredKeys = _h.sent();
                        _h.label = 14;
                    case 14: return [4 /*yield*/, this.signatureProvider.sign({
                    ...
                    case 15:
                        pushTransactionArgs = _h.sent();
                        _h.label = 16;
                    case 16:
                        if (broadcast) {
                            return [2 /*return*/, this.pushSignedTransaction(pushTransactionArgs)];
                        }
                        return [2 /*return*/, __assign({}, pushTransactionArgs, { transactionHeader: transactionHeader //
                             })];
                }
            });
        });
