...
import { GetAbiResult, GetBlockResult, GetCodeResult, GetInfoResult, GetRawCodeAndAbiResult, PushTransactionArgs, GetBlockHeaderStateResult, GetActivatedProtocolFeaturesResult, GetRawAbiResult } from "./eosjs-rpc-interfaces";
/** Make RPC calls */
export declare class JsonRpc implements AuthorityProvider, AbiProvider {
     ...
     */
    constructor(endpoints: string | string[], args?: {
        fetch?: (input?: string | Request, init?: RequestInit) => Promise<Response>;
    });
    fetchWithTimeout(url: string, options: any, timeout?: number): any;
    nextEndpoint(): void;
    ...
    get_activated_protocol_features(limit?: number): Promise<GetActivatedProtocolFeaturesResult>;
