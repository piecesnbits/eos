...
var JsonRpc = /** @class */ (function () {
    ...
    JsonRpc.prototype.fetch = function (path, body, currentRetries) {
        ...
        return __awaiter(this, void 0, void 0, function () {
            var response, json, e_2, headTime, ct, secondsBehind;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 3:
                        e_2 = _a.sent();
                        console.log('Error from', this.currentEndpoint, e_2);
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_b) {
                switch (_b.label) {
                    ...
                    case 2:
                        e_3 = _b.sent();
                        if (e_3 && e_3.json && e_3.json.error) {
                            expired = e_3.json.error.name === 'expired_tx_exception';
                            if (expired) {
                                e_3.json.error.message = 'Transaction Expired: Try Again';
                                this.nextEndpoint();
                            }
                        }
                        throw e_3;
